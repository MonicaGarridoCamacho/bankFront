export const environment = {
  ...
  websocket: 'http://banking-2-alpha.apps.cluster-fkl5f.fkl5f.sandbox3089.opentlc.com',
  backend: 'http://banking-2-alpha.apps.cluster-fkl5f.fkl5f.sandbox3089.opentlc.com'
};
