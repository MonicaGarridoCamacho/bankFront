export const environment = {
  ...
  websocket: 'https://banking-1-alpha.apps.cluster-8hvnk.8hvnk.sandbox2233.opentlc.com',
  backend: 'https://banking-1-alpha.apps.cluster-8hvnk.8hvnk.sandbox2233.opentlc.com'
};
