...
export const environment = {
  ...
  websocket: 'http://banking-12-alpha.apps.cluster-dw8rc.dw8rc.sandbox2609.opentlc.com',
  backend: 'http://banking-12-alpha.apps.cluster-dw8rc.dw8rc.sandbox2609.opentlc.com'
};
/*
