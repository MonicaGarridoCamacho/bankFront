...
export const environment = {
  ...
  websocket: 'http://banking-1-alpha.apps.cluster-fkl5f.fkl5f.sandbox3089.opentlc.com',
  backend: 'http://banking-1-alpha.apps.cluster-fkl5f.fkl5f.sandbox3089.opentlc.com'
};
/*
