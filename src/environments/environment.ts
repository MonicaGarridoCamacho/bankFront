...
export const environment = {
  ...
  websocket: 'https://banking-1-alpha.apps.cluster-9ddp2.9ddp2.sandbox2472.opentlc.com',
  backend: 'https://banking-1-alpha.apps.cluster-9ddp2.9ddp2.sandbox2472.opentlc.com'
};
/*
